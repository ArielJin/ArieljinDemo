...
public class ApiParameters {
	...
	public void addAll(ApiParameters parameters) {
	...
	/**
	 * copy the old ApiParameters
	 * method desc：
	 * @param params
	 * @return
	 */
	public static ApiParameters copy(ApiParameters params) {
	    if(params == null) 
	    {
	        return null;
	    }
	    ApiParameters newParams = new ApiParameters();
